...
## Corpus Check
- 121 files · ~65,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 730 nodes · 1252 edges · 51 communities (43 shown, 8 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea5cf466`
...
1. `run()` - 17 edges
2. `build_enhanced_signals()` - 16 edges
...
Cohesion: 0.09
Nodes (53): adx(), anchored_vwap(), atr_wilder(), bollinger(), cvd_from_ticks(), cvd_proxy(), ema(), macd() (+45 more)
...
Cohesion: 0.2
Nodes (27): _all_param_bounds(), _bars_per_day(), _exit_params(), _forward_metrics(), _forward_pair(), _guardrail_failures(), _infer_tf(), _jitter_seed_params() (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.12
Nodes (24): _add_optimizer_args(), build_parser(), _cmd_download(), _cmd_find(), _cmd_run(), _cmd_smoke(), _finder_kwargs(), main() (+16 more)
...
## Knowledge Gaps
- **188 isolated node(s):** `Download Binance OHLC candles into the local DuckDB cache.  This script is inten`, `Parse YYYY-MM-DD or ISO datetime as UTC.`, `Run untouched forward-test data with optimizer-selected parameters.  This script`, `Download all files under the `algo/` directory from a Snowflake Workspace to yo`, `Replicates the scoring logic from auto_algo_finder.py` (+183 more)
...
- **Why does `run_tick_validation()` connect `Community 3` to `Community 1`, `Community 12`, `Community 30`, `Community 22`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `_build_scorer_signals()` connect `Community 30` to `Community 13`, `Community 3`, `Community 21`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `backtest_strategy()` connect `Community 2` to `Community 0`, `Community 8`, `Community 12`, `Community 30`?**
...
- **Are the 2 inferred relationships involving `build_enhanced_signals()` (e.g. with `apply_registered_components()` and `run_tick_validation()`) actually correct?**
  _`build_enhanced_signals()` has 2 INFERRED edges - model-reasoned connections that need verification._
